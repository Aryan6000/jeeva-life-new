...
import { ADMIN_PARTICIPANTS } from "@/lib/jeeva/demo";
...
export const Route = createFileRoute("/admin/participants")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Search the programme roster and review attendance and engagement status per participant.",
      },
      { property: "og:title", content: "Participants — JeevaLife Admin" },
      { property: "og:description", content: "Roster, attendance and engagement status for the programme." },
      ...
      <AdminCard>
        ...
        <div className="mt-4 overflow-x-auto">
          <table className="w-full min-w-[680px] border-collapse text-left">
            ...
            <tbody>
              {rows.map((p) => (
                <tr key={p.id} className="border-b border-border text-[13px] last:border-b-0">
                  ...
                  <td className="py-3">
                    <Tag
                      label={p.attendance}
                      tone={p.attendance === "Present" ? "mint" : "peach"}
                    />
                  </td>
                  <td className="py-3">
                    <Tag
